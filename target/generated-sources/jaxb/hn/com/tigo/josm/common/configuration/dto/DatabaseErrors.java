...
/**
 * <p>Clase Java para databaseErrors complex type.
 * 
 ...
 *         &lt;element name="constraints" type="{http://tigo.com.hn/persistence/DatabaseErrorMappingMap/v1}ConstraintDetails" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "databaseErrors", namespace = "http://tigo.com.hn/persistence/DatabaseErrorMappingMap/v1", propOrder = {
    "errorCode",
    "constraints"
})
    ...
    implements Serializable
{
    ...
    protected List<ConstraintDetails> constraints;
     ...
     * 
     */
    public List<ConstraintDetails> getConstraints() {
        if (constraints == null) {
            constraints = new ArrayList<ConstraintDetails>();
        }
