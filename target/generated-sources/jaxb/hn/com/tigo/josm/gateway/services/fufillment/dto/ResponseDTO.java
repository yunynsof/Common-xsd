...
@XmlSeeAlso({
    ActivateProductResponseDTO.class,
    SellProductResponseDTO.class,
    GetPaymentMethodsResponseDTO.class,
    GetAcquiredProductDTO.class,
    PurchaseProductResponseDTO.class,
    TransferProductResponseDTO.class,
    GetOffersResponseDTO.class,
    ProductPriceListDTO.class,
    LoanProductResponseDTO.class
})
