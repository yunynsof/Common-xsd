...
/**
 * <p>Clase Java para productDTO complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="acquisitionMethods" type="{http://ws.business.api.fulfillmentengine.millicom.com/}acquisitionMethodPriceDTO" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="planTypes" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
public class ProductDTO {
    ...
    protected List<AcquisitionMethodPriceDTO> acquisitionMethods;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected List<String> planTypes;
    @XmlElement(nillable = true)
     ...
     * {@link AcquisitionMethodPriceDTO }
     * 
     * 
     */
    public List<AcquisitionMethodPriceDTO> getAcquisitionMethods() {
        if (acquisitionMethods == null) {
            acquisitionMethods = new ArrayList<AcquisitionMethodPriceDTO>();
        }
    ...
    /**
     * Obtiene el valor de la propiedad durationTime.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
    ...
    /**
     * Define el valor de la propiedad durationTime.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
    ...
    /**
     * Gets the value of the planTypes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the planTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPlanTypes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getPlanTypes() {
        if (planTypes == null) {
            planTypes = new ArrayList<String>();
        }
